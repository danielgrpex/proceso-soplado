...
import { ESTADOS_HISTORIAL } from "../_components/constants";
import { hasEstado } from "../_components/utils";
import { ExplainBadge } from "../_components/badges";
...
export default function Page() {
  ...
  const filtered = useMemo(
    () => items.filter((r) => hasEstado(r?.Estado, ESTADOS_HISTORIAL)),
    [items]
  );
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      <ExplainBadge
        title="Historial — Soplado"
        subtitle="Solo órdenes finalizadas"
      />
